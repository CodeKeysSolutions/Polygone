...
onNet("fw-businesses:Client:BicycleShop:PurchaseBike", async (Data: {
    ...
    const Finished = await FW.Functions.CompactProgressbar(15000, "Purchasing, do not move...", false, true, {disableMovement: false, disableCarMovement: false, disableMouse: false, disableCombat: false}, {}, {}, {}, false)
    if (!Finished) return;
            ...
            Options: [
                {
                    Name: 'purchase',
                    Icon: 'fas fa-circle',
                    Label: `Bicycle ${isRental ? "rent" : "buy"}`,
                    EventType: 'Client',
