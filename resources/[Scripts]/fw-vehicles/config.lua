...
Config.ImpoundList = {
    {
        Title = 'Vehicle Scuff',
        Desc = 'Vehicle is in an irreparable state.',
        Hours = 0, Fee = 0, Strikes = 0,
        Gov = false,
    },
    {
        Title = 'Evidence of a crime',
        Desc = 'The vehicle was used in or is evidence of a crime.',
        Hours = 12, Fee = 0, Strikes = 0,
        Gov = true,
    },
    {
        Title = 'Joyride',
        Desc = 'Vehicle stolen without the owner\'s permission.',
        Hours = 1, Fee = 800, Strikes = 0,
        Gov = true,
    },
    {
        Title = 'Parking Violation',
        Desc = 'Vehicle parked in a restricted or unauthorized location.',
        Hours = 0, Fee = 400, Strikes = 0,
        Gov = true,
    },
    {
        Title = 'Leaving the Scene of an Accident',
        Desc = 'The vehicle left the scene of an accident resulting in injury or death.',
        Hours = 0, Fee = 950, Strikes = 0,
        Gov = true,
    },
    {
        Title = 'Escape',
        Desc = 'The vehicle was used to flee from an officer.',
        Hours = 24, Fee = 1250, Strikes = 1,
        Gov = true,
    },
    {
        Title = 'Reckless Driving',
        Desc = 'Driven carelessly with great disregard for human life.',
        Hours = 0, Fee = 490, Strikes = 0,
        Gov = true,
    },
    {
        Title = 'Street Racing',
        Desc = 'Vehicle was used in a speed or time contest on public roads/highways.',
        Hours = 0, Fee = 900, Strikes = 2,
        Gov = true,
    },
    {
        Title = 'Driving Under the Influence',
        Desc = 'Driving under the influence of drugs and/or alcohol.',
        Hours = 0, Fee = 150, Strikes = 0,
        Gov = true,
    },
    {
        Title = 'Violent Crime',
        Desc = 'Used in the commission of a violent crime, such as a drive-by shooting, or for transport to and from the scene of a violent crime.',
        Hours = 36, Fee = 1750, Strikes = 2,
        Gov = true,
    },
    {
        Title = 'Unusable at Crime Scene',
        Desc = 'Vehicle found in an unusable state at the scene.',
        Hours = 0, Fee = 400, Strikes = 0,
        Gov = true,
    },
    {
        Title = 'Robbery / Kidnapping / Fencing',
        Desc = 'The vehicle was used in the commission of a crime related to theft or kidnapping.',
        Hours = 36, Fee = 2250, Strikes = 2,
        Gov = true,
    },
    {
        Title = 'Crime Not Listed',
        Desc = 'Used in a crime for which there is no impound reason, manual impound.',
        Hours = 0, Fee = 0, Strikes = 0,
        Gov = true,
    },
    -- {
    --     Title = 'Depot Employee',
    --     Desc = 'Send a notification to a depot employee.',
    --     Hours = 0, Fee = 0, Strikes = 0,
    --     Reason = '',
    --     Gov = true,
    -- },
